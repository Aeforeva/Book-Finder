...
const val shortDescription =
    "NATIONAL BESTSELLER • An excellent introduction to a critical period in the history of Rome"
...
val testVolume = Volume(
    ...
    mapOf(
        Pair(
            "smallThumbnail",
            "http://books.google.com/books/content?id=24yRRvkgsc8C&printsec=frontcover&img=1&zoom=5&source=gbs_api"
        ),
        Pair(
            "thumbnail",
            "http://books.google.com/books/content?id=24yRRvkgsc8C&printsec=frontcover&img=1&zoom=1&source=gbs_api"
        )
    ),
    "en",
    "https://books.google.com/books/about/Cicero.html?hl=&id=24yRRvkgsc8C"
)
